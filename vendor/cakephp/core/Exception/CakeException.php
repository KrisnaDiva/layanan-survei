...
class CakeException extends RuntimeException
{
     ...
     * made available in the tampilan when a development error is displayed.
     *
     * @var array
     */
     ...
     *   that are made available in the tampilan, and sprintf()'d into Exception::$_messageTemplate
