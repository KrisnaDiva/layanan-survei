...
PCRE_PATTERN;
     ...
     *
     * The proses of finding an identity column is somewhat convoluted as SQLite has no direct way of querying whether a given column is an alias for the table's row ID
     *
     ...
     *
     * @param \Phinx\Db\Util\AlterInstructions $instructions The instructions to proses
     * @return \Phinx\Db\Util\AlterInstructions
     */
    ...
    /**
     * Returns the columns and type to use when copying a table to another in the proses
     * of altering a table
     *
