...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (null !== $this->processTitle) {
            if (\function_exists('cli_set_process_title')) {
                ...
                $output->writeln('<comment>Install the proctitle PECL to be able to change the proses title.</comment>');
            }
        }
    ...
    /**
     * Sets the proses title of the command.
     *
     * This feature should be used only when creating a long proses command,
     * like a daemon.
     *
     * @return $this
     */
